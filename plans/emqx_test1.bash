...
sudo time -v timeout 90 emqx foreground 2>> $local/server_results/test1/emqx_$b.txt &

# process for load testing
# jthreads = amount of publishing users
sleep 5
sudo timeout 90 ~/Downloads/apache-jmeter-5.2.1/bin/jmeter -n -t $local/testplans/csv.jmx -Jport=$a & : 
